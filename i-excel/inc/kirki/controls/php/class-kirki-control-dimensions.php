...
class Kirki_Control_Dimensions extends Kirki_Control_Base {
	...
	protected function l10n() {
		return array(
			'left-top'       => esc_attr__( 'Left Top', 'i-excel' ),
			'left-center'    => esc_attr__( 'Left Center', 'i-excel' ),
			'left-bottom'    => esc_attr__( 'Left Bottom', 'i-excel' ),
			'right-top'      => esc_attr__( 'Right Top', 'i-excel' ),
			'right-center'   => esc_attr__( 'Right Center', 'i-excel' ),
			'right-bottom'   => esc_attr__( 'Right Bottom', 'i-excel' ),
			'center-top'     => esc_attr__( 'Center Top', 'i-excel' ),
			'center-center'  => esc_attr__( 'Center Center', 'i-excel' ),
			'center-bottom'  => esc_attr__( 'Center Bottom', 'i-excel' ),
			'font-size'      => esc_attr__( 'Font Size', 'i-excel' ),
			'font-weight'    => esc_attr__( 'Font Weight', 'i-excel' ),
			'line-height'    => esc_attr__( 'Line Height', 'i-excel' ),
			'font-style'     => esc_attr__( 'Font Style', 'i-excel' ),
			'letter-spacing' => esc_attr__( 'Letter Spacing', 'i-excel' ),
			'word-spacing'   => esc_attr__( 'Word Spacing', 'i-excel' ),
			'top'            => esc_attr__( 'Top', 'i-excel' ),
			'bottom'         => esc_attr__( 'Bottom', 'i-excel' ),
			'left'           => esc_attr__( 'Left', 'i-excel' ),
			'right'          => esc_attr__( 'Right', 'i-excel' ),
			'center'         => esc_attr__( 'Center', 'i-excel' ),
			'size'           => esc_attr__( 'Size', 'i-excel' ),
			'height'         => esc_attr__( 'Height', 'i-excel' ),
			'spacing'        => esc_attr__( 'Spacing', 'i-excel' ),
			'width'          => esc_attr__( 'Width', 'i-excel' ),
			'height'         => esc_attr__( 'Height', 'i-excel' ),
			'invalid-value'  => esc_attr__( 'Invalid Value', 'i-excel' ),
		);
	}
}
